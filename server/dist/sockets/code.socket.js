...
exports.registerCodeSocket = void 0;
const PROBLEMS = [
    {
        title: "Two Sum",
        difficulty: "Easy",
...
const roomProblem = new Map();
const roomTimer = new Map();
const registerCodeSocket = (io) => {
    io.on("connection", (socket) => {
        ...
        socket.on("join-room", ({ roomId }, callback) => {
            ...
            callback === null || callback === void 0 ? void 0 : callback({
                code: (_a = roomCode.get(roomId)) !== null && _a !== void 0 ? _a : null,
                problem: (_b = roomProblem.get(roomId)) !== null && _b !== void 0 ? _b : null,
                timer: (_c = roomTimer.get(roomId)) !== null && _c !== void 0 ? _c : null,
            });
        });
...
exports.registerCodeSocket = registerCodeSocket;
